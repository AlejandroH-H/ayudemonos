// Iconos SVG en línea (set Lucide, MIT) para evitar emojis y no depender de un
// CDN externo. Se exponen a las vistas como helper `icono(nombre, opts)`.
const ICONOS = {
  ...
  fish:
    '<path d="M6.5 12c.94-3.46 4.94-6 8.5-6 3.56 0 6.06 2.54 7 6-.94 3.47-3.44 6-7 6s-7.56-2.53-8.5-6Z"/><path d="M18 12v.5"/><path d="M16 17.93a9.77 9.77 0 0 1 0-11.86"/><path d="M7 10.67C7 8 5.58 5.97 2.73 5.5c-1 1.5-1 5 .23 6.5-1.24 1.5-1.24 5-.23 6.5C5.58 18.03 7 16 7 13.33"/><path d="M10.46 7.26C10.2 5.88 9.17 4.24 8 3h5.8a2 2 0 0 1 1.98 1.67l.23 1.4"/><path d="M16.01 17.93l.23 1.4A2 2 0 0 1 14.26 21H8.46"/>',
  package:
...
// Devuelve el SVG en línea de un icono. opts: { size, clase }.
function icono(nombre, opts = {}) {
  const inner = ICONOS[nombre] || ICONOS.package;
  const size = opts.size || 18;
  const clase = opts.clase ? ` ${opts.clase}` : '';
  return (
    `<svg class="icono${clase}" xmlns="http://www.w3.org/2000/svg" ` +
